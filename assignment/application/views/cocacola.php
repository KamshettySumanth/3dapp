        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    <li class="nav-item">
                        <a class="nav-link" href="apicocacola">Home</a>
                    </li>
                    <li class="nav-item">
            ...
            <div class="row">
                <div class="col-lg-4 order-lg-1">
                    <div class="d-flex flex-column">
                        <button class="btn btn-custom" onclick="cokeScene(); pepperModelDescription();">Coca Cola</button>
                        <button class="btn btn-custom" onclick="spriteScene(); pepperModelDescription();">Sprite</button>
                        <button class="btn btn-custom" onclick="pepperScene(); pepperModelDescription();">Dr Pepper</button>
                    </div>
                </div>
